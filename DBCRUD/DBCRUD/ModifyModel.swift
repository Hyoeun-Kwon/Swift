...
class ModifyModel{
    ...
    var urlPath = "http://192.168.237.130:8080/ios/studentUpdate_ios.jsp" // + urlAdd ( ?와 & 로 쭉쭉 이어갈 거임)
    
    func modifyItems(code: String, name: String, dept: String, phone: String) -> Bool { //data를 달고 넘어와서 DB연결해야함
